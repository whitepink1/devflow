...
const MobileNav = () => {
    return(<Sheet>
        ...
        <SheetContent side="left" className="background-light900_dark200 border-none px-5">
        ...
        <div>
            ...
            <SignedOut>
                <div className="flex flex-col gap-3">
                    <SheetClose asChild>
                        <Link href='/sign-in'>
                            <Button className="small-medium btn-secondary min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none"><span className="primary-text-gradient">Log In</span></Button>
                        </Link>
                    </SheetClose>
                    <SheetClose asChild>
                        <Link href='/sign-up'>

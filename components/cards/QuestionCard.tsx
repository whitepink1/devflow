...
const QuestionCard = ({_id, title, tags, author, upvotes, views, answers, createdAt, clerkId, userId}: QuestionProps) => {
    const showActionButtons = clerkId && JSON.stringify(userId) === JSON.stringify(author._id);

...
const Page = async ({params, searchParams}: URLProps) => {
    ...
    const userInfo = await getUserInfo({ userId: id })// { userId: id === "edit" ? clerkId : id })
    return(<>
        <div className="flex flex-col-reverse items-start justify-between sm:flex-row">
            <div className="flex flex-col items-start gap-4 lg:flex-row">
                <Image src={userInfo?.user.picture} width={140} height={140} alt="profile picture" className="rounded-full object-cover" />
                <div className="mt-33">
